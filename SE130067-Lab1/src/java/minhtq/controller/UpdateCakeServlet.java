...
public class UpdateCakeServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(UpdateCakeServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, ParseException, NamingException, SQLException {
        ...
        try {
            ...
            if (error) {
                ...
                boolean result = dao.updateCakeAdminRole(dto);
                if (result) {
                    url = "MainController?"
                            + "btAction=Search"
                            + "&txtSearchValue=" + searchValue
                            ...
                            + "&txtPriceFrom=" + priceFrom
                            + "&txtPriceTo=" + priceTo;
                    LOGGER.info(account.getUserID() + " Update new Cake");
                }
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateCakeServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NamingException ex) {
            Logger.getLogger(UpdateCakeServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(UpdateCakeServlet.class.getName()).log(Level.SEVERE, null, ex);
